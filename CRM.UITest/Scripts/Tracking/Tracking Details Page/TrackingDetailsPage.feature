...
Feature: TrackingDetailsPage
	
@GUI
Scenario Outline:Verify tracking details page
...
Scenario Outline:Verify an option New Search and its functionality
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
Then  I have arrived on the tracking details page
Then  I will be able to see An option for creating a New  Search <App_Url>,<NewSearchOption>
Examples: 
...
@GUI@Ignore
Scenario Outline:Verify an export button on tracking details page
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@GUI
Scenario Outline:Verify columns present in tracking details grid
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@GUI
Scenario Outline:Verify 'Tracking Details' button on each shipment record 
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@GUI
Scenario Outline:Verify search shipments option in tracking details page
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@GUI
Scenario Outline:Verify available options to filter the tracking details results
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@GUI
Scenario Outline:Verify the search options present under the search dropdown
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@GUI
Scenario Outline:Verfiy default selected check boxes as search option
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@GUI@Functional
Scenario Outline:Verfiy Select all and Clear all check box functionality
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@Functional
Scenario Outline:Verfiy search functionality in tracking details page
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@Functional
Scenario Outline:Verfiy fields are displayed within information details modal
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@Functional
Scenario Outline:Verfiy expand by default functionality for one tracking number
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@Functional@GUI
Scenario Outline: Verify the left navigation icon 
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And   I enter the '<ValidReferenceNumber>' in the search box
And   I click on the search button
...
@Functional@Ignore
Scenario Outline:Verfiy result grid when none checbox is checked within search option
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
@Functional
Scenario Outline:Verify Functionality of Filter with DateRange without logged in the Application
Given I am a DLS user and launch crm url
When   I have entered valid tracking numbers in login page<TrackingNumber>
Then  I have arrived on the tracking details page
And   I have otpion to filer with date range '<Pickup>'
Examples: 
| Scenario  | TrackingNumber													| Pickup				  |
| S1        | ZZX00204203,3358766320,ZZS11842,ZZX00204206						|  Scheduled to Deliver   |

@Functional
Scenario Outline:Verify Functionality of Filter with DateRange with logged in the Application
Given I am a DLS user and login into application with valid <Username> and <Password>
When  I Click on the Tracking icon in the navigation menu
And I enter the '<ValidReferenceNumber>' in the search box
And I click on the search button
...
And   I have otpion to filer with date range '<Pickup>'
Examples: 
| Scenario | Username | Password | ValidReferenceNumber										    | Pickup				   |
| S1       | zzz      | Te$t1234 |		 ZZX00204203,3358766320,ZZS11842,ZZX00204206            |  Scheduled to Deliver    |
