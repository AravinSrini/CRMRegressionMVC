@Quote
Feature: Regression - Standard Guaranteed Quote creation and verification in Quote List Page 

@Functional
Scenario Outline: Regression_Shp.Entry_Create standard guaranteed quote and Verify in the Quote list Page
	...
	And I Click on Create Quote for a standard Guaranteed Carrier
