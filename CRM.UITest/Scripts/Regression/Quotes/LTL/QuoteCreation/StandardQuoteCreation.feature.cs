...
namespace CRM.UITest.Scripts.Regression.Quotes.LTL.QuoteCreation
{
    ...
    public partial class Regression_StandardQuoteCreationAndVerificationInQuoteListPageFeature
    {
...
#line 1 "StandardQuoteCreation.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Regression - Standard Quote creation and verification in Quote List Page", null, ProgrammingLanguage.CSharp, new string[] {
                        "Quote"});
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Regression - Standard Quote creation and verification in Quote List Page")))
            {
                global::CRM.UITest.Scripts.Regression.Quotes.LTL.QuoteCreation.Regression_StandardQuoteCreationAndVerificationInQuoteListPageFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void Regression_Shp_Entry_CreateStandardQuoteAndVerifyInTheQuoteListPage(string scenarios, string originZipcode, string destinationZipcode, string classification, string weight, string quantity, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Regression_Shp.Entry_Create standard quote and Verify in the Quote list Page", @__tags);
#line 5
...
#line 13
 testRunner.And("I Click on Create Quote for a standard Carrier", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 14
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Regression_Shp.Entry_Create standard quote and Verify in the Quote list Page: Sce" +
            "nario1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Regression - Standard Quote creation and verification in Quote List Page")]
        ...
        public virtual void Regression_Shp_Entry_CreateStandardQuoteAndVerifyInTheQuoteListPage_Scenario1()
        {
#line 5
this.Regression_Shp_Entry_CreateStandardQuoteAndVerifyInTheQuoteListPage("Scenario1", "60606", "60606", "55", "4", "4", ((string[])(null)));
#line hidden
        }
    }
}
