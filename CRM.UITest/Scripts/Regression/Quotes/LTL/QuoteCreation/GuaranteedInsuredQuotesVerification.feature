@Quote
Feature: Regression - Guaranteed Insured Quote creation and verification in Quote List Page 

@Functional
Scenario Outline: Regression_Shp.Entry_Create guaranteed insured quote and Verify in the Quote list Page
	...
	And I Click on Create Quote for a Guaranteed Insured Carrier
...
Examples: 
| Scenarios | OriginZipcode | destinationZipcode | Classification | Weight | Quantity | ShipmentValue |
| Scenario1 | 60606         | 60606              | 55             | 4      | 4        | 10            |