@Regression @Quote @Sprint75 @29466 @Ignore

Feature: Quote List_CustomerSearchFeature_StationUsers
...
Then associated customers should be listed alphabetically for station <SearchOption>
