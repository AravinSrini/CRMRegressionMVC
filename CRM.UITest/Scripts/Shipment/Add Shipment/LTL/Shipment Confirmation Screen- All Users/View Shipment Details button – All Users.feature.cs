...
namespace CRM.UITest.Scripts.Shipment.AddShipment.LTL.ShipmentConfirmationScreen_AllUsers
{
    ...
    public partial class ViewShipmentDetailsButtonAllUsersFeature
    {
...
#line 1 "View Shipment Details button – All Users.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "View Shipment Details button – All Users", null, ProgrammingLanguage.CSharp, new string[] {
                        "28273",
                        "Sprint70",
                        "GUI"});
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "View Shipment Details button – All Users")))
            {
                global::CRM.UITest.Scripts.Shipment.AddShipment.LTL.ShipmentConfirmationScreen_AllUsers.ViewShipmentDetailsButtonAllUsersFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void VerifyTheViewShipmentDetailsButtonAndFunctionalityOnShipmentConfirmationPage_AllUsers(
                    string usertype, 
                    string dAdd2, 
                    string oZip, 
                    string oName, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify the View Shipment Details button and functionality on shipment confirmatio" +
                    "n page -All Users", @__tags);
#line 5
...
#line 8
testRunner.When("I click on the View Shipment Details button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 9
testRunner.Then("I will arrive on the Shipment Details page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Verify the View Shipment Details button and functionality on shipment confirmatio" +
            "n page -All Users: External")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "View Shipment Details button – All Users")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("28273")]
        ...
        public virtual void VerifyTheViewShipmentDetailsButtonAndFunctionalityOnShipmentConfirmationPage_AllUsers_External()
        {
#line 5
this.VerifyTheViewShipmentDetailsButtonAndFunctionalityOnShipmentConfirmationPage_AllUsers("External", "asd", "60606", "DName", "OAddress", "", "DAddress", "60606", "Daddress", "", "Dname", "", "55", "q123asd", "1", "1", "desc", ((string[])(null)));
#line hidden
        }
    }
}
