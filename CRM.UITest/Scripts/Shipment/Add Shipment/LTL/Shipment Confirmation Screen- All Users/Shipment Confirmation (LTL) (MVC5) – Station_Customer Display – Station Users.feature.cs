...
namespace CRM.UITest.Scripts.Shipment.AddShipment.LTL.ShipmentConfirmationScreen_AllUsers
{
    ...
    public partial class ShipmentConfirmationLTLMVC5Station_CustomerDisplayStationUsersFeature
    {
...
#line 1 "Shipment Confirmation (LTL) (MVC5) – Station_Customer Display – Station Users.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Shipment Confirmation (LTL) (MVC5) – Station_Customer Display – Station Users", null, ProgrammingLanguage.CSharp, new string[] {
                        "Sprint70",
                        "28309"});
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Shipment Confirmation (LTL) (MVC5) – Station_Customer Display – Station Users")))
            {
                global::CRM.UITest.Scripts.Shipment.AddShipment.LTL.ShipmentConfirmationScreen_AllUsers.ShipmentConfirmationLTLMVC5Station_CustomerDisplayStationUsersFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void TestToVerifyStation_CustomerDisplay_ShipmentConfirmationLTLMVC5(
                    string usertype, 
                    string dAdd2, 
                    string oZip, 
                    string oName, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Test to verify Station_Customer Display_Shipment Confirmation (LTL) (MVC5)", @__tags);
#line 5
...
#line 8
   testRunner.When("I am on confirmation page of the shipment", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 9
   testRunner.Then(string.Format("I should be display with mapped customer and station name  \'{0}\' on confirmation " +
                        "page", station_Customer), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Test to verify Station_Customer Display_Shipment Confirmation (LTL) (MVC5): Inter" +
            "nal")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Shipment Confirmation (LTL) (MVC5) – Station_Customer Display – Station Users")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("Sprint70")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("28309")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:station_customer", "ZZZ - WEB SERVICES TEST - ZZZ - CZAR CUSTOMER TEST")]
        public virtual void TestToVerifyStation_CustomerDisplay_ShipmentConfirmationLTLMVC5_Internal()
        {
#line 5
this.TestToVerifyStation_CustomerDisplay_ShipmentConfirmationLTLMVC5("Internal", "asd", "60606", "DName", "OAddress", "", "DAddress", "60606", "Daddress", "ZZZ - Czar Customer Test", "Dname", "", "55", "q123asd", "1", "1", "desc", "ZZZ - WEB SERVICES TEST - ZZZ - CZAR CUSTOMER TEST", ((string[])(null)));
#line hidden
        }
    }
}
