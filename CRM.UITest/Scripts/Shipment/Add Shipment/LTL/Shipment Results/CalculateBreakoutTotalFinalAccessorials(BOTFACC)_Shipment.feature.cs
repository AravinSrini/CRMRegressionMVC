...
namespace CRM.UITest.Scripts.Shipment.AddShipment.LTL.ShipmentResults
{
    ...
    public partial class CalculateBreakoutTotalFinalAccessorialsBOTFACC_ShipmentFeature
    {
...
#line 1 "CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Shipment.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Shipment", null, ProgrammingLanguage.CSharp, new string[] {
                        "Sprint72",
                        "30564"});
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Shipment")))
            {
                global::CRM.UITest.Scripts.Shipment.AddShipment.LTL.ShipmentResults.CalculateBreakoutTotalFinalAccessorialsBOTFACC_ShipmentFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void VerifyBOTFACCCalculationsForShipment(
                    string scenario, 
                    string username, 
                    string password, 
                    string customerName, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify BOTFACC calculations for Shipment", @__tags);
#line 5
...
#line 8
testRunner.Then(string.Format("BOTFACC can be calculated and Verified in the Shipment Results page{0},{1},{2},{3" +
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Verify BOTFACC calculations for Shipment: s1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Shipment")]
        ...
        public virtual void VerifyBOTFACCCalculationsForShipment_S1()
        {
#line 5
this.VerifyBOTFACCCalculationsForShipment("s1", "both", "Te$t1234", "ZZZ - GS Customer Test", "COD", "Miami", "33126", "FL", "USA", "Tempe", "85282", "AZ", "USA", "", "COD", "50", "1", "SKD", "3", "Shipment", "External", "BOTFACC", "otest", "oadd1", "dtest", "daadd1", "1234", "dtss", ((string[])(null)));
#line hidden
        }
    }
}
