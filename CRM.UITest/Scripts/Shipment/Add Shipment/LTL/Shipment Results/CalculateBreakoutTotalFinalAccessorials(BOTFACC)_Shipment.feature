@Sprint72 @30564
Feature: CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Shipment

@Functional
Scenario Outline: Verify BOTFACC calculations for Shipment
...
| s1       | both 					| Te$t1234 | ZZZ - GS Customer Test   | COD     | Miami      | 33126     | FL          | USA           | Tempe           | 85282          | AZ               | USA                |              | COD          | 50             | 1        | SKD          | 3      | Shipment | External | BOTFACC         |  otest     |oadd1       |dtest       |daadd1       | 1234     | dtss     |
