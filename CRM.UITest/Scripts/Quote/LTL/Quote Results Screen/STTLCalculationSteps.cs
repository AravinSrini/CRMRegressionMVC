...
{
    [Binding]
    public class STTLCalculationSteps : ObjectRepository
    {
        ...
        public decimal ThenSTTLValueWillBeCalculated()
        {
        ...
        [Then(@"The displayed carrier STTL value in UI of quote result page should match with calculated STTL value")]
        public void ThenTheDisplayedCarrierSTTLValueInUIOfQuoteResultPageShouldMatchWithCalculatedSTTLValue()
        {
