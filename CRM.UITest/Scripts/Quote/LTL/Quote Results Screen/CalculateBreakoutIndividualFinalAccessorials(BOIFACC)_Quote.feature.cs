...
namespace CRM.UITest.Scripts.Quote.LTL.QuoteResultsScreen
{
    ...
    public partial class CalculateBreakoutIndividualFinalAccessorialsBOIFACC_QuoteFeature
    {
...
#line 1 "CalculateBreakoutIndividualFinalAccessorials(BOIFACC)_Quote.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CalculateBreakoutIndividualFinalAccessorials(BOIFACC)_Quote", null, ProgrammingLanguage.CSharp, new string[] {
                        "30563",
                        "Sprint72",
                        "CalculateBreakoutIndividualFinalAccessorials(BOIFACC)_Quote"});
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "CalculateBreakoutIndividualFinalAccessorials(BOIFACC)_Quote")))
            {
                global::CRM.UITest.Scripts.Quote.LTL.QuoteResultsScreen.CalculateBreakoutIndividualFinalAccessorialsBOIFACC_QuoteFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void VerifyTheBOIFACCCalculationsForQuote(
                    string scenario, 
                    string username, 
                    string password, 
                    string customerName, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify the BOIFACC calculations for Quote", @__tags);
#line 6
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Verify the BOIFACC calculations for Quote: s1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "CalculateBreakoutIndividualFinalAccessorials(BOIFACC)_Quote")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("CalculateBreakoutIndividualFinalAccessorials(BOIFACC)_Quote")]
        ...
        public virtual void VerifyTheBOIFACCCalculationsForQuote_S1()
        {
#line 6
this.VerifyTheBOIFACCCalculationsForQuote("s1", "salesmanager@stage.com", "Te$t1234", "ZZZ - Czar Customer Test", "COD", "Miami", "33126", "FL", "USA", "Tempe", "85282", "AZ", "USA", "", "COD", "50", "1", "SKD", "3", "Quote", "Internal", "BOIFACC", ((string[])(null)));
#line hidden
        }
    }
}
