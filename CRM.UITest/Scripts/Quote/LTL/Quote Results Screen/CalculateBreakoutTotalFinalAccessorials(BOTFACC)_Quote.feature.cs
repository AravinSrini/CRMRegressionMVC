...
namespace CRM.UITest.Scripts.Quote.LTL.QuoteResultsScreen
{
    ...
    public partial class CalculateBreakoutTotalFinalAccessorialsBOTFACC_QuoteFeature
    {
...
#line 1 "CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Quote.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Quote", null, ProgrammingLanguage.CSharp, new string[] {
                        "30564",
                        "Sprint72",
                        "CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Quote"});
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Quote")))
            {
                global::CRM.UITest.Scripts.Quote.LTL.QuoteResultsScreen.CalculateBreakoutTotalFinalAccessorialsBOTFACC_QuoteFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void VerifyTheBOTFACCCalculationsForQuote(
                    string scenario, 
                    string username, 
                    string password, 
                    string customerName, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify the BOTFACC calculations for Quote", @__tags);
#line 5
...
#line 8
testRunner.Then(string.Format("BOTFACC can be calculated and Verified in the Rate Results page{0},{1},{2},{3},{4" +
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Verify the BOTFACC calculations for Quote: s1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Quote")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("30564")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("Sprint72")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("CalculateBreakoutTotalFinalAccessorials(BOTFACC)_Quote")]
        ...
        public virtual void VerifyTheBOTFACCCalculationsForQuote_S1()
        {
#line 5
this.VerifyTheBOTFACCCalculationsForQuote("s1", "salesmanager@stage.com", "Te$t1234", "ZZZ - Czar Customer Test", "COD", "Miami", "33126", "FL", "USA", "Tempe", "85282", "AZ", "USA", "", "COD", "50", "1", "SKD", "3", "Quote", "Internal", "BOTFACC", ((string[])(null)));
#line hidden
        }
    }
}
