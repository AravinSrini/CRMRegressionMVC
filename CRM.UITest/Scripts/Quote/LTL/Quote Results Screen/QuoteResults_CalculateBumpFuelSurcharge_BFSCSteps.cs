...
{
    [Binding]
    public class QuoteResults_CalculateBumpFuelSurcharge_BFSCSteps : MaintenaceTools
    {
        ...
        [When(@"I am on the quote results page with calculation for BFSC (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*) and (.*)")]
        public decimal WhenIAmOnTheQuoteResultsPageWithCalculationForBFSCAnd(string Username, string customerAcc, string userType, string oZip,
        ...
        [Then(@"BFSC should be calculated when bump is available and surge is not available (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*) and (.*)")]
        public decimal ThenBFSCShouldBeCalculatedWhenBumpIsAvailableAndSurgeIsNotAvailable(string Username, string customerAcc, string userType, string oZip,
            string oCity, string oState,
            string dZip, string dCity, string dState,
            string classification, string quantity, string weight, string oServices, string dServices)
        {
        ...
        [Then(@"fuel value for carrrier in quote results should be equal to BFSC")]
        public void ThenFuelValueForCarrrierInQuoteResultsShouldBeEqualToBFSC()
        {
            string firstCarrierFuel = Gettext(attributeName_xpath, ".//*[@id='Grid-Rate-List-Large-NonGuranteed']/tbody/tr[1]/td[4]/ul[1]/li[2]");
