...
namespace CRM.UITest.Scripts.Quote.LTL.QuoteResultsScreen
{
    ...
    public partial class CalculateBreakoutLinehaulBOLH_QuoteFeature
    {
...
#line 1 "CalculateBreakoutLinehaul(BOLH)_Quote.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CalculateBreakoutLinehaul(BOLH)_Quote", null, ProgrammingLanguage.CSharp, new string[] {
                        "CalculateBreakoutLinehaul(BOLH)_Quote",
                        "30324",
                        "Sprint72"});
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "CalculateBreakoutLinehaul(BOLH)_Quote")))
            {
                global::CRM.UITest.Scripts.Quote.LTL.QuoteResultsScreen.CalculateBreakoutLinehaulBOLH_QuoteFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void VerifyTheBOLHCalculationsForQuote(
                    string scenario, 
                    string username, 
                    string password, 
                    string customerName, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify the BOLH calculations for Quote", @__tags);
#line 6
...
#line 9
testRunner.Then(string.Format("BOLH can be calculated and Verified in the Rate Results page{0},{1},{2},{3},{4},{" +
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Verify the BOLH calculations for Quote: s1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "CalculateBreakoutLinehaul(BOLH)_Quote")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("CalculateBreakoutLinehaul(BOLH)_Quote")]
        ...
        public virtual void VerifyTheBOLHCalculationsForQuote_S1()
        {
#line 6
this.VerifyTheBOLHCalculationsForQuote("s1", "zzzext", "Te$t1234", "ZZZ - Czar Customer Test", "COD", "Miami", "33126", "FL", "USA", "Tempe", "85282", "AZ", "USA", "", "COD", "50", "1", "SKD", "3", "Quote", "External", "BOLH", ((string[])(null)));
#line hidden
        }
    }
}
