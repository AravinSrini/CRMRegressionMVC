...
{
    [Binding]
    public class BFSCCalculationSteps : Quotelist
    {
        ...
        public decimal ThenBFSCWillBeCalculated()
        {
            ...
            BOFSC = step.calculateBaseMarkDownCharges("ZZZ - GS Customer Test", "service", "Miami", "33126", "FL", "USA",
            ...
            decimal BOLH = step.calculateBaseMarkDownCharges("ZZZ - GS Customer Test", "service", "Miami", "33126", "FL", "USA",
                "Tempe", "85282", "AZ", "USA", "Appointment", "COD", "50", Convert.ToDouble("2"), "skids", Convert.ToDouble("3"), "Quote",
                 "both", "External", "BOLH");
            bumpSurgeCalculationModel.BreakOutLineHaul = BOLH;
            decimal BOTFACC = step.calculateBaseMarkDownCharges("ZZZ - GS Customer Test", "service", "Miami", "33126", "FL", "USA",
                "Tempe", "85282", "AZ", "USA", "Appointment", "COD", "50", Convert.ToDouble("2"), "skids", Convert.ToDouble("3"), "Quote",
        ...
        [Then(@"The displayed carrier fuel surcharge value in UI of quote result page should match with calculated BFSC value")]
        public void ThenTheDisplayedCarrierFuelSurchargeValueInUIOfQuoteResultPageShouldMatchWithCalculatedBFSCValue()
        {
