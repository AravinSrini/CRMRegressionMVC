...
namespace CRM.UITest.Scripts.Quote.LTL.QuoteResultsScreen
{
    ...
    public partial class CalculateBreakoutTotalBOTTL_QuoteFeature
    {
...
#line 1 "CalculateBreakoutTotal(BOTTL)_Quote.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CalculateBreakoutTotal(BOTTL)_Quote", null, ProgrammingLanguage.CSharp, new string[] {
                        "30565",
                        "Sprint72",
                        "CalculateBreakoutTotal(BOTTL)_Quote"});
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "CalculateBreakoutTotal(BOTTL)_Quote")))
            {
                global::CRM.UITest.Scripts.Quote.LTL.QuoteResultsScreen.CalculateBreakoutTotalBOTTL_QuoteFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void VerifyBOTTLCalculationForLTLRateRequest(
                    string scenario, 
                    string username, 
                    string password, 
                    string customerName, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify BOTTL calculation for LTL Rate Request", @__tags);
#line 5
...
#line 8
testRunner.Then(string.Format("BOTTL can be calculated and Verified in the Rate Results page{0},{1},{2},{3},{4}," +
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Verify BOTTL calculation for LTL Rate Request: s1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "CalculateBreakoutTotal(BOTTL)_Quote")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("CalculateBreakoutTotal(BOTTL)_Quote")]
        ...
        public virtual void VerifyBOTTLCalculationForLTLRateRequest_S1()
        {
#line 5
this.VerifyBOTTLCalculationForLTLRateRequest("s1", "Both@test.com", "Te$t1234", "ZZZ - GS Customer Test", "COD", "Miami", "33126", "FL", "USA", "Tempe", "85282", "AZ", "USA", "", "COD", "50", "1", "SKD", "3", "Quote", "External", "BOTTL", ((string[])(null)));
#line hidden
        }
    }
}
