...
Then the Length value "30.00" will be applied to the Length field on the Get Quote (LTL) page
And the Width value "20.00" will be applied to the Width field on the Get Quote (LTL) page
And the Height value "10.00" will be applied to the Height field on the Get Quote (LTL) page.
...
And I have entered the required information for Length, Width, Height, Weight, and Quantity "30", "20", "10", "100", "1"
When I click on the Apply Class Button
Then the Length value "30.00" will be applied to the Length field on the Get Quote (LTL) page for the additional item
And the Width value "20.00" will be applied to the Width field on the Get Quote (LTL) page for the additional item
And the Height value "10.00" will be applied to the Height field on the Get Quote (LTL) page for the additional item
