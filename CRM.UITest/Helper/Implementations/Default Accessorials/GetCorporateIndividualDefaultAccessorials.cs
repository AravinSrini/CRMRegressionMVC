...
{
    public class GetCorporateIndividualDefaultAccessorials : IGetCorporateIndividualDefaultAccessorials
    {
        public List<DefaultAccessorialSetupModel> GetDefaultIndividualAccessorialsForCorporate()
        {
