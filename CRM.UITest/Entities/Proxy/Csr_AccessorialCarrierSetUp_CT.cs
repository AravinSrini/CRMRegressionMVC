...
namespace CRM.UITest.Entities.Proxy
{
    ...
    public partial class Csr_AccessorialCarrierSetUp_CT
    {
        ...
        public Nullable<int> AccessorialCustomerCarrierSetupId { get; set; }
        public Nullable<int> CustomerAccountId { get; set; }
        public string CarrierSCAC { get; set; }
        public string AccessorialCode { get; set; }
        public Nullable<decimal> AccessorialValue { get; set; }
